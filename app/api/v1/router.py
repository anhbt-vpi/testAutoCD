...
@router.get("/products/{product}/international/price/daily/facet", response_model=schemas.FacetModel)
...
@router.get("/products/{product}/international/price/daily", response_model=schemas.ItemBase)
